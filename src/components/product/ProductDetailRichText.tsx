...
export function ProductDetailRichText({ detail }: { detail: ProductDetailBlock }) {
  ...
  if (detail.richTextHtml?.trim()) {
    return (
      <div
        className={`tm-copy tm-text-muted mt-3 grid gap-3 whitespace-normal font-medium leading-8 ${copySizeClass[detail.textSize || 'base']} ${textAlignClass[detail.textAlign || 'right']} [&_a]:font-extrabold [&_a]:text-[#b45309] [&_a]:underline [&_a]:underline-offset-4 [&_b]:font-extrabold [&_blockquote]:rounded-md [&_blockquote]:border-r-4 [&_blockquote]:border-[#b45309] [&_blockquote]:bg-[#fff7e8] [&_blockquote]:px-4 [&_blockquote]:py-3 [&_blockquote]:font-bold [&_font[size='2']]:text-xs [&_font[size='3']]:text-sm [&_font[size='4']]:text-lg [&_font[size='5']]:text-2xl [&_font[size='6']]:text-3xl [&_h1]:tm-heading [&_h1]:font-heading [&_h1]:text-4xl [&_h1]:font-black [&_h1]:leading-tight [&_h2]:tm-heading [&_h2]:font-heading [&_h2]:text-3xl [&_h2]:font-black [&_h2]:leading-tight [&_h3]:tm-heading [&_h3]:font-heading [&_h3]:text-2xl [&_h3]:font-black [&_h4]:tm-heading [&_h4]:font-heading [&_h4]:text-xl [&_h4]:font-extrabold [&_hr]:my-4 [&_hr]:border-[#dbe4dd] [&_img]:my-3 [&_img]:max-h-[420px] [&_img]:w-full [&_img]:rounded-md [&_img]:object-contain [&_li]:leading-8 [&_mark]:rounded [&_mark]:px-1 [&_ol]:grid [&_ol]:list-decimal [&_ol]:gap-2 [&_ol]:pr-5 [&_pre]:my-3 [&_pre]:overflow-x-auto [&_pre]:rounded-md [&_pre]:bg-[#131921] [&_pre]:p-3 [&_pre]:text-left [&_pre]:text-white [&_strong]:font-extrabold [&_table]:mt-3 [&_table]:w-full [&_table]:overflow-hidden [&_table]:rounded-md [&_table]:border [&_table]:border-[#dbe4dd] [&_table]:bg-white [&_td]:border [&_td]:border-[#dbe4dd] [&_td]:px-3 [&_td]:py-2 [&_th]:border [&_th]:border-[#dbe4dd] [&_th]:px-3 [&_th]:py-2 [&_ul]:grid [&_ul]:list-disc [&_ul]:gap-2 [&_ul]:pr-5 [&_video]:my-3 [&_video]:max-h-[420px] [&_video]:w-full [&_video]:rounded-md`}
        style={style}
